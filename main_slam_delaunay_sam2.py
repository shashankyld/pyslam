                ...
                if img is not None:
                    ...
                    if img is not None:
                        ...
                        if img_id > starting_img_id+2:
                            ...
                            if slam.map.get_frame(-1).img_id != img_id: # This is the assumption for the delaunay code.
                                raise AssertionError(f"Frame ID mismatch: slam.map.get_frame(-1).id = {slam.map.get_frame(-1).img_id}, current img_id = {img_id}")
