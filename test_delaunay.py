...
if __name__ == "__main__":
    ...
    # online_poses_path = "/home/shashank/Documents/UniBonn/thesis/pyslam/results/metrics_20250421_012513_rgbd_bonn_balloon_tracking2_pyslam_original/trajectory_online.txt"
    ...
    pose1 = poses[starting_frame]
    pose2 = poses[ending_frame]
    print("pose1", pose1)
    print("pose2", pose2)
    ...
    """
    ref_feat = filter_features_by_depth2(ref_feat, depth1_scaled)
    curr_feat = filter_features_by_depth2(curr_feat, depth2_scaled)
